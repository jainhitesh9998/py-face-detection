...
pnet, rnet, onet = detect_face.create_mtcnn(sess, align_path.get())

# read 20170512-110547 model file downloaded from https://drive.google.com/file/d/0B5MzpY9kBtDVZ2RpVDYwWmxoSUk
print(facenet_path.get())
facenet.load_model(facenet_path.get("20170512-110547.pb"))
...
# img1 = cv2.imread(image_path.get(args.img1))
# img2 = cv2.imread(image_path.get(args.img2))
